...
export default function RandomTournamentPage() {
  return (
    <div className="container mx-auto flex flex-col items-center justify-center flex-1 py-12 px-4 md:px-6 text-center">
      <Shuffle className="h-16 w-16 text-primary mb-6" />
      <h1 className="text-4xl md:text-5xl font-bold font-headline text-primary mb-6">
        Torneo Random
      </h1>
      <p className="text-lg text-muted-foreground mb-8 max-w-xl">
        Esta sección está actualmente en desarrollo. ¡Vuelve pronto para generar torneos aleatorios y disfrutar de partidos emocionantes!
      </p>
      <Link href="/" passHref>
